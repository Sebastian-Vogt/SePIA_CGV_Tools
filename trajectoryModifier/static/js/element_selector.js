...
function button_visibility() {
    for (let t = 0; t < trajectories.length; t++) {
        ...
        let lat = trajectories[t].positions_rotations_and_boxes[0].position[0];
        let long = trajectories[t].positions_rotations_and_boxes[0].position[1];
        ...
        for (let p = 0; p < trajectories[t].positions_rotations_and_boxes.length; p++) {
            ...
            if (lat != trajectories[t].positions_rotations_and_boxes[p].position[0] || long != trajectories[t].positions_rotations_and_boxes[p].position[1]) {
